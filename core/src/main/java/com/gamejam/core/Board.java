...
public class Board {
    ...
    Content.Name[] contents = new Content.Name[]{Content.Name.BODO, Content.Name.FRAGE, Content.Name.EMPTY, Content.Name.ENEMY,
        ...
        Content.Name.ENEMY, Content.Name.EMPTY, Content.Name.ENEMY, Content.Name.FRAGE, Content.Name.EMPTY, Content.Name.BODO,
        Content.Name.TRAP, Content.Name.ENEMY, Content.Name.BODO, Content.Name.EMPTY, Content.Name.BODO, Content.Name.EMPTY,
        Content.Name.EMPTY, Content.Name.EMPTY, Content.Name.BODO};
